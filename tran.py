...
class Train(object):
    def __init__(self, yolo, data):
        ...
        self.variable_to_restore = tf.global_variables()[:-4]
    ...
    def train(self):
        ...
        for step in xrange(0, self.max_step):
            ...
            if step % self.summary_iter == 0:
                if step % 10 == 0:
                    ...
                    log_str = ('{} Epoch: {}, Step: {},\n train_Loss: {:.4f}, test_Loss: {:.4f},\n Remain: {}').format(
                        ...
                        loss, sum_loss/num, self.remain(step, initial_time))
                    print(log_str)

...
class YOLO6D_net:
    ...
    def __init__(self, is_training=True):
        ...
        self.logit        = self.build_networks(self.input_images)  # shape: [batch, cell, cell, 19]
        self.labels       = tf.placeholder(tf.float32, [self.Batch_Size, self.cell_size, self.cell_size, 19], name='labels')
...
# ======================== Net definition ==================================
    ...
    def build_networks(self, inputs):
        ...
        net = self.conv_layer(net, [1, 1, 1024, 19], batch_norm=False, name = '30_conv', activation='linear') # for 18 coords and 1 confidence

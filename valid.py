...
class Detector(object):
    ...
    def draw(self, box, image_path):
        ...
        cv2.circle(image, (xc, yc), 3, (155, 255, 255), 1)
        cv2.line(image, (x1, y1), (x3, y3), (100,100,100), 2)
        cv2.line(image, (x1, y1), (x5, y5), (100,100,100), 2)
        cv2.line(image, (x3, y3), (x7, y7), (100,100,100), 2)
        cv2.line(image, (x5, y5), (x7, y7), (100,100,100), 2)

        cv2.line(image, (x2, y2), (x4, y4), (100,100,100), 2)
        cv2.line(image, (x2, y2), (x6, y6), (100,100,100), 2)
        cv2.line(image, (x8, y8), (x4, y4), (100,100,100), 2)
        cv2.line(image, (x8, y8), (x6, y6), (100,100,100), 2)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weights', default='yolo_6d_ape.ckpt', type=str)

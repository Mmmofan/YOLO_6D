...
class YOLONet(object):
    ...
    def __init__(self, is_training=True):
        ...
        self.output_size = (self.cell_size * self.cell_size) * (self.num_class + self.boxes_per_cell * 5)  ##total output size
        self.scale = 1.0 * self.image_size / self.cell_size
        self.boundary1 = self.cell_size * self.cell_size * self.num_class  ##part 1 of output_size
        self.boundary2 = self.boundary1 + self.cell_size * self.cell_size * self.boxes_per_cell  ##part 2 of output_size
    ...
    def loss_layer(self, predicts, labels, scope='loss_layer'):
        with tf.variable_scope(scope):
            ...
            ###offset shape : [batch_size, cell_size, cell_size, boxes_per_cell]
